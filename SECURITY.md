...
If you find a security vulnerability in stopwatch, please report it through [GitHub's private vulnerability reporting](https://github.com/AbelKidaneHaile/stopwatch/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact abelkidanehaile@gmail.com for details.
